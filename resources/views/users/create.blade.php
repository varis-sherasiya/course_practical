        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="personal_email" value="{{ old('personal_email') }}"
                                placeholder="Personal Email" class="form-control">
                    ...
                    <!-- Repeat this error block for each input field -->
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <strong>Phone No.:</strong>
                            <input type="text" name="phone_no" value="{{ old('phone_no') }}" placeholder="Phone No."
                                class="form-control">
                            @error('phone_no')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="number" name="address" placeholder="Address" class="form-control">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
